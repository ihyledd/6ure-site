    ...
    <div className="about-container">
      ...
      <section ref={statsSectionRef} className="about-stats about-reveal" data-reveal aria-label="Community stats">
        ...
        <div className="about-stat-card">
          ...
          <div className="about-stat-label">Presets</div>
        </div>
        ...
        <div className="about-websites-grid about-reveal" data-reveal>
          ...
          {discordUrl && (
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="about-website-card"
            >
              <span className="about-website-icon" aria-hidden="true">
                <DiscordIcon />
              </span>
              <h3 className="about-website-title">{PRESETS_CARD.title}</h3>
              <p className="about-website-desc">{PRESETS_CARD.desc}</p>
              <span className="about-website-link">{PRESETS_CARD.link} →</span>
            </a>
          )}
        </div>
      </section>
