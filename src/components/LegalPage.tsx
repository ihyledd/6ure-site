    ...
    content: (
      <>
        ...
        <div className="legal-summary-box">
          ...
          <ul>
            <li>We operate the 6ure website (About, Wiki, Password hub, Verify), the 6ure Requests platform, <strong>application forms</strong>, and use <strong>Discord</strong> for login across platforms.</li>
        ...
        <p>6ure operates: (a) the 6ure website (6ureleaks.com), including the About page, Wiki, Password hub, Verify page, and application forms; (b) the 6ure Requests platform (6ureleaks.com/requests); and (c) the contact and &quot;Suggest changes&quot; feedback forms. For the purpose of data protection law, we are the data controller. Contact us at <a href="mailto:contact@6ureleaks.com">contact@6ureleaks.com</a> for any privacy-related request or question.</p>
        ...
        <h3 id="privacy-changes">11. Changes to this policy</h3>
    ...
    content: (
      <>
        ...
        <div className="legal-summary-box">
          <h3 className="legal-summary-title">In short</h3>
          <ul>
            <li>These terms apply to all 6ure platforms: the website (About, Wiki, Password hub, Verify), Requests, <strong>application forms</strong>, and feedback forms.</li>
        ...
        <p>By creating an account, logging in via Discord, or otherwise using any 6ure platform - including the 6ure website (About, Wiki, Password hub, Verify), the Requests platform (6ureleaks.com/requests), application forms, and feedback forms (contact, Suggest changes) - you agree to these Terms and to our <Link href="/privacy">Privacy Policy</Link>. Continued use after we update these Terms constitutes acceptance of the updated Terms.</p>
        ...
        <h3 id="terms-use">4. Use of the platform</h3>
        <p>You must use our platforms lawfully and in line with these Terms and any rules we publish (e.g. in our Discord server). You must not: submit or promote content that infringes copyright or others&apos; rights; use the service for illegal activity, fraud, or harassment; circumvent access controls (e.g. Password hub, Wiki unlocks) or abuse our systems; impersonate others. On Requests, certain creator or product links may be protected or blocked; you must not attempt to bypass those rules.</p>
        <h3 id="terms-content">5. Content and conduct</h3>
        ...
        <h3 id="terms-moderation">6. Moderation</h3>
        ...
        <h3 id="terms-ip">7. Your content and intellectual property</h3>
        ...
        <h3 id="terms-service">8. Our service</h3>
        <p>We provide the platform <strong>as-is</strong> and <strong>as available</strong>. We do not guarantee uninterrupted access or accuracy of user-generated content. We may change, suspend, or discontinue features with reasonable notice where practicable.</p>
        <h3 id="terms-liability">9. Limitation of liability</h3>
        ...
        <h3 id="terms-indemnity">10. Indemnification</h3>
        ...
        <h3 id="terms-termination">11. Termination</h3>
        <p>We may suspend or terminate your access at any time, with or without cause or notice. You may stop using the service at any time. Upon termination, your right to use the platform ceases; we may retain or delete your data as described in our Privacy Policy.</p>
        <h3 id="terms-changes">12. Changes to the terms</h3>
        ...
        <h3 id="terms-contact">13. Contact</h3>
        <p>For questions about these Terms, or to report violations or request takedowns, contact us at <a href="mailto:contact@6ureleaks.com">contact@6ureleaks.com</a>. We will respond as reasonably practicable.</p>
      </>
    ),
  },
  dmca: {
    ...
    <main className="legal-page">
      <div className="legal-card">
        ...
        <footer className="legal-meta">
          <p className="legal-effective">This policy is effective immediately and applies to all users of 6ure platforms (website, Wiki, Password hub, Verify, Requests, application forms, feedback forms).</p>
        </footer>
