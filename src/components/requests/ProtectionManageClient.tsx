...
import { ProtectedResourcesTab } from "./ProtectedResourcesTab";
...
export function ProtectionManageClient() {
  ...
  const [activeTab, setActiveTab] = useState<"users" | "links" | "resources">("users");
  ...
  return (
    <div className="dashboard-content-block">
      ...
      <div className="protection-manage-tabs">
        ...
        <button
          type="button"
          className={`protection-manage-tab ${activeTab === "resources" ? "active" : ""}`}
      ...
      {activeTab === "resources" && <ProtectedResourcesTab />}
