    ...
    >
      ...
      >
        <div className="ure-user-info">
          ...
          {!!user.leak_protection ? (
            <span className="ure-protected-badge" title="Leak Protection">
              <ShieldIcon /> Protected
            </span>
          ) : null}
          {(user.tags || []).includes("protected") ? (
            <span className="ure-protected-badge" title="Protected user — uploads of this user's content are blocked" style={{ background: "rgba(237, 66, 69, 0.15)", color: "#ed4245", border: "1px solid rgba(237, 66, 69, 0.3)" }}>
              <ShieldIcon /> Protected
            </span>
          ) : null}
        ...
        <div className="ure-user-dropdown">
          <div className="ure-dropdown-header">
            <div className="ure-dropdown-avatar-wrap">
              ...
              {!!user.leak_protection ? (
                <div 
                  className="ure-dropdown-avatar-badge" 
                  title="Leak Protection"
                  style={{ 
                    bottom: -2, 
                    left: -2, 
                    right: "auto", 
                    background: "linear-gradient(135deg, #7c9082 0%, #5a6b5e 100%)",
                    color: "white",
                    borderColor: "var(--bg-tertiary, #1a1a1d)"
                  }}
                >
                  <ShieldIcon />
                </div>
          ...
          <div className="ure-dropdown-items">
            ...
            {(user.role === "ADMIN" || user.role === "LEAKER") && (
              <>
                ...
                <Link
                  ...
                  onClick={() => setOpen(false)}
                >
                  <CrownIcon /> {user.role === "ADMIN" ? "Admin Dashboard" : "Leaker Dashboard"}
                </Link>
              </>
            )}
            <div className="ure-dropdown-divider-subtle" />
