  ...
  if (!sub) {
    return (
      <div className="dashboard-wide" style={{ maxWidth: 1200, margin: "0 auto", padding: 24 }}>
        ...
        <Link href="/admin/subscriptions" style={{ color: "#5865f2", fontSize: 14, marginTop: 12, display: "inline-block" }}>
          &larr; Back to list
        </Link>
      </div>
    );
  ...
  return (
    <div className="dashboard-wide text-white" style={{ maxWidth: 1200, margin: "0 auto", padding: 24 }}>
      <div style={{ display: "flex", flexWrap: "wrap", alignItems: "flex-start", gap: 16, marginBottom: 28 }}>
        <Link href="/admin/subscriptions" style={{ color: "#5865f2", fontSize: 14, textDecoration: "none", paddingTop: 4 }}>
          &larr; Back to list
        </Link>
