  ...
  return (
    <div style={{ marginBottom: 48 }}>
      <div className="dashboard-section-header">
        <h2>Edit category</h2>
        <p>
          <Link href="/admin/categories" style={{ color: "var(--discord-blurple)" }}>Categories</Link> / Edit
        </p>
      </div>
      ...
      <form action={updateAction} className="dashboard-card" style={{ display: "flex", flexDirection: "column", gap: 20, maxWidth: 480 }}>
        ...
        <div style={{ display: "flex", gap: 12 }}>
          ...
          <Link href="/admin/categories" className="dashboard-btn dashboard-btn-ghost">Cancel</Link>
        </div>
      </form>
    </div>
  );
