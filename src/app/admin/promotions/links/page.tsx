  ...
  return (
    <>
      <div className="dash-header">
        ...
        <Link href="/admin/promotions/links/new" className="promo-action-btn promo-action-primary">
          + New Link
        </Link>
      </div>
            ...
            <tbody>
              {links.map((l) => (
                <tr key={l.id} className={!l.is_active ? "promo-row-inactive" : undefined}>
                  <td>
                    <Link href={`/admin/promotions/links/${l.id}/edit`} className="promo-link-name">
                      {l.resource_name}
                    </Link>
                  </td>
                  <td>
                  ...
                  <td>
                    <div className="promo-actions-cell">
                      <Link href={`/admin/promotions/links/${l.id}/edit`} className="promo-action-sm">Edit</Link>
