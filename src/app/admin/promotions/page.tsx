  ...
  return (
    <>
      ...
      <div className="promo-actions-row">
        ...
        <Link href="/admin/promotions/links/new" className="promo-action-btn">
          + New Download Link
        </Link>
        <Link href="/admin/promotions/analytics" className="promo-action-btn">
          View Analytics
        </Link>
      </div>
            ...
            <table className="promo-table">
              ...
              <tbody>
                {links.map((link) => (
                  <tr key={link.id}>
                    <td>
                      <Link href={`/admin/promotions/links/${link.id}/edit`} className="promo-link-name">
                        {link.resource_name}
                      </Link>
                    </td>
