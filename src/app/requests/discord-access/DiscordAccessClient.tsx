...
export function DiscordAccessClient() {
        ...
        <article className="discord-access-article">
          ...
          <section className="discord-access-cta-box" aria-label="Need help?">
            ...
            <div className="discord-access-cta-buttons">
              <a href="https://discord.gg/6ure" target="_blank" rel="noopener noreferrer" className="discord-access-btn discord-access-btn-primary">
                Join our Discord
              </a>
