          ...
          <table className="promo-table">
            ...
            <tbody>
              {campaigns.map((c) => (
                <tr key={c.id}>
                  <td>
                    <Link href={`/dashboard/promotions/campaigns/${c.id}/edit`} className="promo-link-name">
                      {c.name}
                    </Link>
                  </td>
                  <td>
                  ...
                  <td>
                    <div className="promo-actions-cell">
                      <Link href={`/dashboard/promotions/campaigns/${c.id}/edit`} className="promo-action-sm">
                        Edit
                      </Link>
