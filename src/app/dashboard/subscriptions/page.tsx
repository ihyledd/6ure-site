    ...
    <div className="dashboard-wide subs-dash">
      ...
      <div className="subs-dash-header">
        ...
        <div className="subs-dash-actions">
          ...
          <Link href="/dashboard/subscriptions/promo-codes" style={{ padding: "8px 16px", background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.08)", borderRadius: 8, color: "#b9bbbe", fontSize: 13, fontWeight: 600, textDecoration: "none" }}>
            Promo Codes
          </Link>
          <Link href="/dashboard/subscriptions/analytics" style={{ padding: "8px 16px", background: "rgba(88,101,242,0.8)", border: "none", borderRadius: 8, color: "#fff", fontSize: 13, fontWeight: 600, textDecoration: "none" }}>
            Analytics
          </Link>
        </div>
      </div>
            ...
            {loading ? (
              ...
              <tr key={sub.id}>
                ...
                <td style={{ textAlign: "right" }}>
                  <Link href={`/dashboard/subscriptions/${sub.id}`} className="subs-table-link">View Details</Link>
                </td>
              </tr>
            ))}
          </tbody>
