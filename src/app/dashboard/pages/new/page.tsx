    ...
    <div style={{ marginBottom: 48 }}>
      ...
      <form action={createPageAction} className="dashboard-card" style={{ display: "flex", flexDirection: "column", gap: 20, maxWidth: "none" }}>
        ...
        <div className="dashboard-form-group">
          ...
          <input name="description" placeholder="A short summary of this page..." maxLength={200} />
        </div>
        <div className="dashboard-form-group">
        ...
        <div className="dashboard-form-group">
          <label>Password lock <span style={{ fontWeight: 400, color: "var(--text-tertiary)" }}>(leave empty for no lock)</span></label>
          <input name="page_password" type="text" placeholder="Enter a password to lock this page" style={{ maxWidth: 360 }} />
        </div>
        <div>
